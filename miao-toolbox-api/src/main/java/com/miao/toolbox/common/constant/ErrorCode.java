...
public final class ErrorCode {
    ...
    public static final String SCHEDULER_SCRIPT_NOT_FOUND = "SCHEDULER_SCRIPT_NOT_FOUND";
    public static final String SCHEDULER_SCRIPT_NAME_DUPLICATED = "SCHEDULER_SCRIPT_NAME_DUPLICATED";
    public static final String SCHEDULER_SCRIPT_VERSION_NOT_FOUND = "SCHEDULER_SCRIPT_VERSION_NOT_FOUND";
    public static final String SCHEDULER_SCRIPT_IN_USE = "SCHEDULER_SCRIPT_IN_USE";
    public static final String SCHEDULER_SCRIPT_CONTENT_TOO_LARGE = "SCHEDULER_SCRIPT_CONTENT_TOO_LARGE";
    public static final String SCHEDULER_SCRIPT_TYPE_INVALID = "SCHEDULER_SCRIPT_TYPE_INVALID";
}
